        ...
        <div className="flex gap-3 mt-auto">
          ...
          {hasImages && (
            <button
              ...
              className="flex items-center justify-center gap-1.5 flex-1 px-4 py-2.5 rounded text-xs font-semibold tracking-wide uppercase transition-colors duration-200"
              style={{
